...
| diversification part 1/2/3             | Списки в тексте (Часть 2 и 3 — текст раскрыт). Картинка/схема — по желанию. |

**Проверка:** у опубликованных статей с картинками alt на языке статьи (RU/EN/ES) — пройдено. Черновики (FA, onchain, diversification) — списки на месте; картинки при необходимости добавить позже.
...
После добавления списков проверить, нужны ли картинки для усиления — при необходимости добавить по чеклисту выше (alt на языке статьи).
