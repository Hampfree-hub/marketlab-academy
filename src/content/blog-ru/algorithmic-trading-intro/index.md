...
*Доля HFT в объёме торгов США достигла пика в 2010 году, затем стабилизировалась на уровне 50-60%.*
...
*Пример настройки Grid-бота в Veles: указание диапазона, количества ордеров и размера позиции.*
...
*Простая стратегия на TradingView: пересечение MA(50) и MA(200) генерирует сигналы на покупку (зелёные метки) и продажу (красные метки).*
