---
title: 'Алгоритмический трейдинг: от палки первобытного человека до крипто-ботов'
...
**1971:** NASDAQ — первая электронная биржа.

- Никаких трейдеров в яме
- Все сделки через компьютер
- Начало эры автоматизации
...
**Что умеет ИИ:**
- Анализировать новости (NLP)
- Распознавать паттерны на графике (CNN)
- Оптимизировать параметры стратегии (RL)
...
**Алгоритм:**
- Если BTC на Bybit = $95,000, а на Binance = $95,500
- Купить на Bybit, продать на Binance
- Прибыль: $500 (минус комиссии)

**Пример:**
- Разница цен: 0.5-2%
- Объём: $100,000
- Прибыль за сделку: $500-2,000
- Сделок в день: 10-50
...
| **Волатильность** | 1-3% в день | 5-20% в день |
...
| **HFT** | 60-70% объёма | 5-10% объёма |
| **Доступность** | Квалифицированные инвесторы | Любой с интернетом |

**Вывод:** Крипта доступнее, волатильнее, но рискованнее.
...
**Готовые платформы:**
- **3Commas:** DCA, Grid, бэктест ($20-100/месяц)
- **Veles:** Алготрейдинг для крипты, бэктесты, облачные боты (от $15/месяц) — [попробовать Veles](https://veles.finance/invite/washmallay)
...
- **3Commas:** DCA, Grid, Trailing ($20-100/месяц)
- **Cryptohopper:** Готовые стратегии, маркетплейс ($20-100/месяц)
- **Veles:** Облачные боты, бэктесты, простой интерфейс (от $15/месяц) — [попробовать Veles](https://veles.finance/invite/washmallay)
- **Gainium:** Grid, DCA, маркет-мейкинг (бесплатно до 2 ботов)
- **Antbot:** Сигналы, копитрейдинг
- **TradingView:** Сигналы, алерты, Pine Script (бесплатно- $50/месяц)
