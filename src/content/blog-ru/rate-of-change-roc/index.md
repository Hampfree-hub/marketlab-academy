...
ROC (Rate of Change) — осциллятор импульса: он показывает, на сколько процентов изменилась цена за выбранный период. Нулевая линия и отклонения выше/ниже неё дают представление об ускорении или замедлении движения и возможных разворотах. В статье — как считается ROC, как читать уровни и дивергенции и как комбинировать его с [RSI](https://marketlab-academy.org/ru/library/technical-analysis-rsi/) и [Williams %R](https://marketlab-academy.org/ru/library/williams-percent-range-r/) в одной линейке осцилляторов.
...
ROC относится к осцилляторам импульса (моментума). Он не ограничен фиксированным диапазоном, в отличие от [RSI](https://marketlab-academy.org/ru/library/technical-analysis-rsi/) (0–100) или [Williams %R](https://marketlab-academy.org/ru/library/williams-percent-range-r/) (0…−100). Чем сильнее движение цены за N периодов, тем больше по модулю значение ROC. Это помогает оценивать силу и скорость движения и замечать дивергенции — расхождения между ценой и ROC, часто предшествующие развороту.
...
Период N выбирает трейдер. Часто используют 9, 12 или 14 (как у RSI). Короткий период даёт более чувствительный индикатор с большим количеством сигналов; длинный — более сглаженный. Выбор зависит от [таймфрейма](https://marketlab-academy.org/ru/library/timeframes-trading/) и стиля торговли. Имеет смысл проверять настройки в [бэктестах](https://marketlab-academy.org/ru/library/what-are-backtests/).
...
**Дивергенция:** когда цена формирует новый максимум, а ROC — более низкий (медвежья дивергенция), это может указывать на ослабление восходящего импульса и возможный разворот вниз. Когда цена делает новый минимум, а ROC — более высокий (бычья дивергенция), импульс падения может ослабевать. Дивергенции ROC, как и [дивергенции RSI](https://marketlab-academy.org/ru/library/technical-analysis-rsi/), стоит подтверждать уровнями или объёмом.
...
- **ROC + объём:** [Индекс денежного потока (MFI)](https://marketlab-academy.org/ru/library/money-flow-index/) учитывает объём; ROC — только цену. ROC даёт «скорость» движения цены, MFI — подкрепление движением объёма.

Не стоит ставить на график слишком много осцилляторов: 2–3 обычно достаточно. Подробнее о комбинациях индикаторов — в статье про [торговые сигналы](https://marketlab-academy.org/ru/library/what-are-trading-signals/).

## Применение в криптотрейдинге

Криптовалютный рынок волатилен, поэтому ROC на криптопарах нередко даёт большие по модулю значения. На малых [таймфреймах](https://marketlab-academy.org/ru/library/timeframes-trading/) ROC очень чувствителен — много сигналов и шума; на старших (H4, D1) сигналы реже, но часто значимее. Дивергенции ROC на крипто хорошо видны в моменты сильных движений; их имеет смысл проверять вместе с [ложными пробоями](https://marketlab-academy.org/ru/library/false-breakouts-trading/) и уровнями.

Перед использованием в реальной торговле стратегию с ROC рекомендуется протестировать на истории. Как это делать — в материале [что такое бэктесты](https://marketlab-academy.org/ru/library/what-are-backtests/).
