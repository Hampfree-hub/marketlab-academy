...
![График роста цены Биткоина с 2009 по 2026 год](./assets/bitcoin-price-chart.webp)
...
![Пример транзакции Биткоина в блокчейне с отправителем и получателем](./assets/transaction-example.webp)
...
![Сравнение аппаратных мобильных и биржевых кошельков для Биткоина](./assets/wallet-types-comparison.webp)
...
Биткоин можно приобрести через криптовалютные биржи, онлайн-обменники или платежные системы. Для более подробной информации о работе с криптовалютой, изучите [полное руководство по Биткоину](/ru/library/what-bitcoin-everything-you-need-know/).
