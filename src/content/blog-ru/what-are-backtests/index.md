...
Оптимизация — это процесс поиска наилучших значений параметров стратегии. Например, при стратегии на основе [индикатора MFI](/ru/library/money-flow-index) можно тестировать различные периоды индикатора и уровни перекупленности/перепроданности.
