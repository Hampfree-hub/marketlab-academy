...
2. **Оптимизация параметров** — помогает найти оптимальные значения для индикаторов, уровней стоп-лосса, тейк-профита и других настроек. Например, при работе с [индикатором RSI](https://marketlab-academy.org/ru/library/technical-analysis-rsi) можно протестировать различные периоды и уровни перекупленности/перепроданности.
...
**Пример использования:** Можно протестировать стратегию на основе [свечных паттернов](https://marketlab-academy.org/ru/library/what-are-doji-candles), например, доджи свечей в комбинации с другими сигналами.
...
Оптимизация — это процесс поиска наилучших значений параметров стратегии. Например, при стратегии на основе [индикатора MFI](https://marketlab-academy.org/ru/library/money-flow-index) можно тестировать различные периоды индикатора и уровни перекупленности/перепроданности.
