...
Таймфрейм — это временной интервал, который задаёт одну свечу (или бар) на графике. От выбора таймфрейма зависят настройки индикаторов, количество сигналов и тип стратегии: скальпинг, внутридневная торговля или свинг. В статье — что такое таймфреймы, как они обозначаются, как выбирать под свой стиль и как увязывать с [RSI](https://marketlab-academy.org/ru/library/technical-analysis-rsi/), [бэктестами](https://marketlab-academy.org/ru/library/what-are-backtests/) и стратегиями.
...
**Дневные и выше:** D1 (день), W1 (неделя), MN (месяц). Применяются для свинг-трейдинга и позиционной торговли. Сигналы редкие, но уровни и паттерны считаются более значимыми. На [ложные пробои](https://marketlab-academy.org/ru/library/false-breakouts-trading/) обращают внимание чаще на H4 и D1, чем на M1–M15.
...
**Скальпинг:** цель — много небольших сделок за день. Обычно используют M1, M5, реже M15. Важны быстрая реакция, минимальные комиссии и спреды. Индикаторы настраивают на короткие периоды; [RSI](https://marketlab-academy.org/ru/library/technical-analysis-rsi/) на M1 даёт много сигналов, часть из них лучше фильтровать старшим таймфреймом.
...
**Свинг:** позиции держат от нескольких дней до недель. Используют H4, D1, иногда W1. Количество сделок меньше, зато меньше и «шума». Подходит тем, кто не может следить за графиком постоянно. Стратегии для [бокового тренда](https://marketlab-academy.org/ru/library/sideways-trend-strategies/) и разворота часто тестируют на H4 и D1.
...
- Период индикаторов задаётся в свечах выбранного таймфрейма; настройки лучше проверять в [бэктестах](https://marketlab-academy.org/ru/library/what-are-backtests/).
