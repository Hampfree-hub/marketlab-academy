...
![График RSI с зонами перекупленности 70 и перепроданности 30 на криптовалютном рынке](./assets/rsi-zones.webp)
...
![Пример бычьей дивергенции RSI с формированием более высокого минимума индикатора при падении цены](./assets/rsi-bullish-divergence.webp)
...
![Пример медвежьей дивергенции RSI с формированием более низкого максимума индикатора при росте цены](./assets/rsi-bearish-divergence.webp)
...
![Сравнение графиков RSI и индекса денежного потока MFI на одном таймфрейме](./assets/rsi-vs-mfi-comparison.webp)
...
![Пример использования RSI на разных таймфреймах для подтверждения торговых сигналов](./assets/rsi-timeframes.webp)
