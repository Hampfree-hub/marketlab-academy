...
Ключевой фактор, который пока позволяет оставаться на плаву, — диверсификация: часть стратегий не пересекается по активам и таймфреймам, часть работает на других биржах и с другим плечом. Дополнительную подушку даёт аккаунт на BingX, куда мы относительно недавно масштабировались: там крутится стратегия [ORACLE 1.1](/ru/library/oracle-strategy/) — по сути независимый модуль с собственным профилем просадки и периодами восстановления. Задача статьи — честно показать: да, просадка есть, да, она неприятная, но это часть заранее заложенного сценария, а не «чёрный лебедь».
