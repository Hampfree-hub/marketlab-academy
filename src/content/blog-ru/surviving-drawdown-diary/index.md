...
Сейчас у нас нет задачи «нарисовать красивую историю задним числом» — это живой срез. По аккаунту [Bybit](https://www.bybit.com/ru-RU/invite?ref=PWMD24) просадка уже ощутимая, но по нашим риск-параметрам остаётся некритичной: лимиты по максимально допустимому снижению капитала ещё не выбиты, система не требует экстренной разгрузки. Недавно по одному из активов сработал стоп-лосс — он не «спас» от общей просадки по счёту, но локально защитил от более глубокой ямы и показал, что дисциплина риск-менеджмента работает и на падающем рынке.
