---
title: 'Ethereum простыми словами: что это, как работает, зачем нужен ETH'
description: 'Ethereum для начинающих: блокчейн, смарт-контракты, газ, стейкинг. Чем ETH отличается от Bitcoin. Полное руководство 2026.'
pubDate: '2026-03-15'
category: 'crypto'
draft: true
---
...
*Цена ETH прошла путь от $1,400 (2017) до $200+ (2025). Ключевые события: ICO бум, DeFi Summer, The Merge, одобрение ETF.*
...
*Комиссии Ethereum варьируются от $1-5 в спокойное время до $50-100 в пик нагрузки. Layer 2 решают эту проблему.*
...
*Arbitrum Bridge: перевод ETH с Ethereum mainnet на Arbitrum занимает ~10-15 минут, комиссии ~$1-5.*
