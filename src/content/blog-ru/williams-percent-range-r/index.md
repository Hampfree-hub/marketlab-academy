...
# Процентный диапазон Вильямса (%R) в криптовалютной торговле
...
- [Технический анализ RSI](/ru/technical-analysis-rsi) — детальный разбор индекса относительной силы.
- [Индекс денежного потока (MFI)](/ru/money-flow-index) — осциллятор, учитывающий объемы торгов.
- [Основы Биткоина](/ru/bitcoin-basics) — базовые знания для начала торговли.
