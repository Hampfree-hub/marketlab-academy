...
It makes sense to use FA as a filter: first “is this asset worth looking at at all,” then technical analysis for the entry point. For a 15-minute check, see the [fundamental analysis checklist](/en/library/fundamental-analysis-checklist/).
...
- **On-chain metrics** — data from the chain itself: MVRV, NVT, exchange reserves, coin flows. They show how participants behave “inside” the network. For more, see the article on [on-chain metrics in fundamental analysis](/en/library/onchain-metrics-fundamental-analysis/).
