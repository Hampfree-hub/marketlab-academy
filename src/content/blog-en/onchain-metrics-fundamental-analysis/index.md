...
Like MVRV, SOPR is better used as sentiment filter, not sole trigger. Combination with technical analysis (levels, volume, [RSI](/en/library/technical-analysis-rsi/)) gives more stable decisions.
