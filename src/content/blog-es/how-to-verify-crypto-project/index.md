...
**Importante:** Este checklist es un filtro "basura/no basura", no una recomendación de compra. Para análisis profundo, ver [Análisis Fundamental: Checklist de 15 Minutos](/es/library/fundamental-analysis-checklist/).
...
| Parámetro | Excelente | Normal | Riesgo |
|-----------|-----------|--------|--------|
...
Para una verificación más detallada, usa [checklist extendido de 15 minutos](/es/library/fundamental-analysis-checklist/), que incluye verificación de tokenomics y métricas on-chain. También recomendamos estudiar [conceptos básicos de tokenomics](/es/library/what-is-tokenomics/) y [gestión de riesgos](/es/library/risk-management-crypto-trading-bots/) para evaluación de riesgos.
