---
title: 'Estrategias para mercados laterales (rango)'
...
![Ejemplo de rango: el precio se mueve entre soporte y resistencia](./assets/range-bounds.png)
...
![Ejemplo de grid: rejilla de órdenes dentro del rango](./assets/grid-example.png)
