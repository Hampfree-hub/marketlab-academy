...
![Gráfico RSI con zona de sobrecompra 70 y zona de sobreventa 30 en el mercado de criptomonedas](./assets/rsi-zones.webp)
...
![Ejemplo de divergencia alcista RSI con el indicador formando un mínimo más alto mientras el precio cae](./assets/rsi-bullish-divergence.webp)
...
![Ejemplo de divergencia bajista RSI con el indicador formando un máximo más bajo mientras el precio sube](./assets/rsi-bearish-divergence.webp)
...
![Comparación de gráficos RSI e Índice de Flujo de Dinero MFI en el mismo marco temporal](./assets/rsi-vs-mfi-comparison.webp)
...
![Ejemplo de uso de RSI en diferentes marcos temporales para confirmar señales de trading](./assets/rsi-timeframes.webp)
